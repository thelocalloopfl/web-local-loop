...
const hasEvents = Array.isArray(allEvents) && allEvents.length > 0;
  ...
  return (
    <>
        <div className="main-content mx-auto px-5 py-16  max-w-7xl">
              {/* Header */}
        ...
        <EventSubmissionForm />
            ...
            <div className="bg-gradient-to-r from-yellow-300 via-white to-orange-300 rounded-lg shadow p-2 mt-10 py-8 text-center text-black lg:p-8">
